...
miz write --allow-device-write --yes --new-uuids image.raw <block-device>  # also freshen GPT/FAT/ext4/XFS identities safely
...
Before confirmation, `miz write` also inventories the source identifiers and,
...
With `--new-uuids`, `miz write` generates a fresh GPT disk GUID, a fresh GUID
