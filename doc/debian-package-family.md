...
should use `vmiz` and `vmiz_host`. Host builds require libzstd. Package-family
consumers additionally pick up debz's liblzma/libzstd development-library
requirements through its Zig build module.
