...
and
[`Ubuntu-26.04-20260829`](https://github.com/cataggar/miz/releases/tag/Ubuntu-26.04-20260829)
releases remain immutable and are not retargeted. The four-asset workflow uses
the new tag `Ubuntu-26.04-20260905`, which is the first release to carry the
minimized core images of issue #677; that tag and release do not become final
until all four candidates pass digest-bound same-architecture QEMU acceptance
