...
//! explicit `miz-local-provisioning` marker used by mizinit to select
...
//!
//! Uses direct `mount(2)`/`umount(2)` syscalls (matching `mizinit`'s
...
pub const local_provisioning_marker = "miz-local-provisioning";
