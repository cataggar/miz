...
azure_trusted_launch_disk_create_args \
  RESOURCE_GROUP DISK_NAME REGION VHD_FILE_BYTES ARCHITECTURE
...
azure_trusted_launch_image_definition_create_args \
  RESOURCE_GROUP GALLERY IMAGE_DEFINITION OFFER SKU ARCHITECTURE REGION
azure_trusted_launch_print_command
azure_trusted_launch_image_definition_show_args \
  RESOURCE_GROUP GALLERY IMAGE_DEFINITION
azure_trusted_launch_print_command ' > image-definition.json'
printf '%s\n' \
...
azure_trusted_launch_vm_create_args \
  ...
  '/subscriptions/SUBSCRIPTION_ID/resourceGroups/RESOURCE_GROUP/providers/Microsoft.Compute/galleries/GALLERY/images/IMAGE_DEFINITION/versions/IMAGE_VERSION' \
  ADMIN_USER PUBLIC_KEY_FILE true false
azure_trusted_launch_print_command

azure_trusted_launch_vm_resource_security_args RESOURCE_GROUP VM_NAME
azure_trusted_launch_print_command ' > vm-security.json'
azure_trusted_launch_vm_instance_security_args RESOURCE_GROUP VM_NAME
azure_trusted_launch_print_command ' > instance-security.json'
printf '%s\n' \
