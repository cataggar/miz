//! miz: a Zig library for reading and writing VM disk image formats
...
pub const efi_varstore = @import("efi_varstore.zig");
...
pub const DeviceIdentityInventory = block_device.IdentityInventory;
pub const DeviceIdentityCollision = block_device.Collision;
pub const DeviceIdentityCollisionReport = block_device.CollisionReport;
