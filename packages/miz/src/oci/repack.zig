...
pub const Options = struct {
    created_by: []const u8 = "miz oci repack",
...
pub fn repackLayout(
    ...
    var lock = try bundle_dir.createFile(io, ".miz/repack.lock", .{
        .read = true,
        .truncate = false,
        .lock = .exclusive,
    });
    ...
    const temporary_tar = try createUniqueTempFile(io, allocator, bundle_dir, ".miz", "layer.tar");
