...
pub const modules_load_path = "etc/modules-load.d/miz.conf";
pub const modprobe_blacklist_path = "etc/modprobe.d/miz-blacklist.conf";
pub const modprobe_options_path = "etc/modprobe.d/miz-options.conf";
...
test "typed customization applies files accounts SSH services and modules" {
    ...
    const module_options = try tree.readFileAlloc(std.testing.allocator, "etc/modprobe.d/miz-options.conf", 4096);
