...
test "the release identifier uses one calendar date everywhere" {
    var workflow = try open();
    defer workflow.deinit();
    try workflow.expectContains("group: ubuntu2604-release-20260907");
    try workflow.expectContains("RELEASE_TAG: Ubuntu-26.04-20260907");
    try workflow.expectContains("RELEASE_TITLE: Ubuntu 26.04 full and core - 20260907");
